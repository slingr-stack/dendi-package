...
exports.get = function(path, httpOptions, callbackData, callbacks) {
    ...
    return httpService.get(DendiLIS(options), callbackData, callbacks);
};
...
exports.post = function(path, httpOptions, callbackData, callbacks) {
    let options = checkHttpOptions(path, httpOptions);
    return httpService.post(DendiLIS(options), callbackData, callbacks);
};
...
exports.put = function(path, httpOptions, callbackData, callbacks) {
    let options = checkHttpOptions(path, httpOptions);
    return httpService.put(DendiLIS(options), callbackData, callbacks);
};
...
exports.patch = function(path, httpOptions, callbackData, callbacks) {
    let options = checkHttpOptions(path, httpOptions);
    return httpService.patch(DendiLIS(options), callbackData, callbacks);
};
...
exports.delete = function(path, httpOptions, callbackData, callbacks) {
    let options = checkHttpOptions(path, httpOptions);
    return httpService.delete(DendiLIS(options), callbackData, callbacks);
};
...
exports.head = function(path, httpOptions, callbackData, callbacks) {
    let options = checkHttpOptions(path, httpOptions);
    return httpService.head(DendiLIS(options), callbackData, callbacks);
};
...
exports.options = function(path, httpOptions, callbackData, callbacks) {
    let options = checkHttpOptions(path, httpOptions);
    return httpService.options(DendiLIS(options), callbackData, callbacks);
};
...
exports.utils = {
    ...
    getConfiguration: function (property) {
        if (!property) {
            sys.logs.debug('[dendi] Get configuration');
            return JSON.stringify(config.get());
        }
        sys.logs.debug('[dendi] Get property: '+property);
...
function setApiUri(options) {
    ...
    sys.logs.debug('[dendi] Set url: ' + options.path + "->" + options.url);
    return options;
}
...
function setAuthorization(options) {
    sys.logs.debug('[dendi] Setting header token oauth');
